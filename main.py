...
bot_token = os.environ.get("TOKEN",""6716826768:AAHoz26c8s20h3tEcbhQfNdHc9QUXHyaiZU) # Botunuzun Tokenini Girin.
sahib = os.environ.get("sahib"@b_12032") # Sahiplik Hesabin Kullanıcı Adını Girin .
BOT_ID = int(os.environ.get("BOT_ID", "6716826768")) # Botunuzun İd'si ( Tokenin Başındaki Rakamları ) Girin .
DATABASE_URL = os.environ.get("DATABASE_URL","") # MongoDB veritabanınızın url'si.
BOT_USERNAME = os.environ.get("BOT_USERNAME","http://t.me/Deneme1299bot") # Botunuzun kullanıcı adı.
...
OWNER_ID = int(os.environ.get("OWNER_ID","6415771260")) # Sahip hesabın id'si
